...
public class PaginationServiceTest {
  ...
  void givenCurrentPageNmberAndTotalPages_whenCalculating_thenReturnsPaginationBarNumbers(
  ...
  static Stream<Arguments> givenCurrentPageNmberAndTotalPages_whenCalculating_thenReturnsPaginationBarNumbers() {
    return Stream.of(
