package io.github.gdtknight.security;
...
public record BoardPrincipal(
  ...
  public static BoardPrincipal of(
      String username, String password, String email, String nickname, String memo) {
  ...
  public static BoardPrincipal fromDto(UserAccountDto dto) {
    return BoardPrincipal.of(
        dto.userId(), dto.userPassword(), dto.email(), dto.nickname(), dto.memo());
  }
